 ...
 */
class Contracts extends GestimagApi
{
	/**
	...
	public function get($id)
	{
		...
		if (!GestimagApi::_checkAccessToResource('contrat', $this->contract->id)) {
	...
	{
		if (!GestimagApiAccess::$user->hasRight('contrat', 'creer')) {
		...
		if ($this->contract->create(GestimagApiAccess::$user) < 0) {
	...
	public function activateLine($id, $lineid, $datestart, $dateend = null, $comment = null)
	{
		...
		$updateRes = $this->contract->active_line(GestimagApiAccess::$user, $lineid, $datestart, $dateend, $comment);
	...
	public function unactivateLine($id, $lineid, $datestart, $comment = null)
	{
		...
		$updateRes = $this->contract->close_line(GestimagApiAccess::$user, $lineid, $datestart, $comment);
	...
	public function deleteLine($id, $lineid)
	{
		...
		$updateRes = $this->contract->deleteLine($lineid, GestimagApiAccess::$user);
		if ($updateRes > 0) {
			return $this->get($id);
		} else {
	...
	public function put($id, $request_data = null)
	{
		...
		if ($this->contract->update(GestimagApiAccess::$user) > 0) {
			return $this->get($id);
		} else {
	...
	{
		if (!GestimagApiAccess::$user->hasRight('contrat', 'supprimer')) {
			throw new RestException(403);
		}
		$result = $this->contract->fetch($id);
		if (!$result) {
		...
		if (!$this->contract->delete(GestimagApiAccess::$user)) {
	...
	public function validate($id, $notrigger = 0)
	{
		...
		$result = $this->contract->validate(GestimagApiAccess::$user, '', $notrigger);
		if ($result == 0) {
	...
	public function close($id, $notrigger = 0)
	{
		...
		$result = $this->contract->closeAll(GestimagApiAccess::$user, $notrigger);
		if ($result == 0) {
