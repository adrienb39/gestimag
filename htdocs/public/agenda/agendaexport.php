 ...
 * 				http://127.0.0.1/gestimag/public/agenda/agendaexport.php?format=vcal&exportkey=cle
 * 				http://127.0.0.1/gestimag/public/agenda/agendaexport.php?format=ical&type=event&exportkey=cle
 * 				http://127.0.0.1/gestimag/public/agenda/agendaexport.php?format=rss&exportkey=cle
...
if ($shortfilename == 'gestimagcalendar') {
	$langs->load("errors");
