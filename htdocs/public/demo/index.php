...
// Security check
global $gestimag_main_demo;
if (empty($gestimag_main_demo)) {
	httponly_accessforbidden('Parameter gestimag_main_demo must be defined in conf file with value "default login,default pass" to enable the demo entry page');
}
...
if (empty($reshook)) {
	$demoprofiles = array(
		array(
			...
			//'icon'=>DOL_URL_ROOT.'/public/demo/gestimag_screenshot8.png',
		...
		array(
			...
			//'icon'=>DOL_URL_ROOT.'/public/demo/gestimag_screenshot2.png',
		...
		array(
			...
			//'icon'=>DOL_URL_ROOT.'/public/demo/gestimag_screenshot6.png',
		...
		array(
			...
			//'icon'=>DOL_URL_ROOT.'/public/demo/gestimag_screenshot9.png'
...
$head .= '<meta name="description" content="Gestimag ERP and CRM demo. You can test here several profiles for Gestimag ERP and CRM demonstration.">'."\n";
