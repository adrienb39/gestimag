...
$original_file = $gestimag_main_data_root.($conf->entity > 1 ? '/'.$conf->entity : '').'/website/'.$website.'/styles.css.php';
...
echo '/* Page content '.$original_file.' : CSS content that was saved into tpl dir */'."\n";
