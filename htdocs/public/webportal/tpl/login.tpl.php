		...
		<div class="login-screen__content">
			<form class="login" method="POST">
				...
				<div class="login__field">
					...
					<input type="text" class="login__input" name="login" placeholder="<?php echo dol_escape_htmltag($langs->trans('loginWebportalUserName')); ?>">
				</div>
				<div class="login__field">
					<i class="login__icon fas fa-lock"></i>
					<input type="password" class="login__input" name="password" placeholder="<?php echo dol_escape_htmltag($langs->trans('Password')) ?>">
				</div>
				<button class="button login__submit">
					<span class="button__text"><?php echo dol_escape_htmltag($langs->trans('Connection')) ?></span>
