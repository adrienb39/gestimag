...
?>
<!DOCTYPE html>
<?php echo '<html lang="'.substr($langs->defaultlang, 0, 2) . '">'."\n"; ?>
<head>
	<meta charset="UTF-8">
	...
	<link rel="stylesheet" href="<?php echo $context->rootUrl.'css/global.css.php'; ?>">
	...
	echo '<script src="'.$jNotifyJSUrl.'"></script>';
	?>
</head>
