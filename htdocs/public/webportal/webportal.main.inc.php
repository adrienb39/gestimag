...
if (!function_exists('dol_getprefix')) {
	...
	function dol_getprefix($mode = '')
	{
		...
		$gestimag_main_cookie_cryptkey; // This is loaded by filefunc.inc.php

		$tmp_instance_unique_id = empty($gestimag_main_instance_unique_id) ?
			(empty($gestimag_main_cookie_cryptkey) ? '' :
				$gestimag_main_cookie_cryptkey) : $gestimag_main_instance_unique_id;
