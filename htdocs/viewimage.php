 ...
 *		\brief      Wrapper to show images into Gestimag screens.
...
if (GETPOST("cache", 'alpha')) {
	// Important: The following code is to avoid a page request by the browser and PHP CPU at each Gestimag page access.
