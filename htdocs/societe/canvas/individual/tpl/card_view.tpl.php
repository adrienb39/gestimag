...
echo "<!-- BEGIN PHP TEMPLATE CARD_VIEW.TPL.PHP INDIVIDUAL -->\n";
...
<tr>
	<td width="25%" valign="top"><?php echo  $langs->trans("LinkedToGestimagMember"); ?></td>
...
echo $formfile->showdocuments('company', $socid, $filedir, $urlsource, $genallowed, $delallowed, '', 0, 0, 0, 28, 0, '', 0, '', $objcanvas->control->object->default_lang);
?>
