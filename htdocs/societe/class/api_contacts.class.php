 ...
 */
class Contacts extends GestimagApi
{
	/**
	 *
	...
	{
		if (!GestimagApiAccess::$user->hasRight('societe', 'contact', 'lire')) {
		...
		if (!GestimagApi::_checkAccessToResource('contact', $this->contact->id, 'socpeople&societe')) {
	...
	public function post($request_data = null)
	{
		...
		if ($this->contact->create(GestimagApiAccess::$user) < 0) {
	...
	public function put($id, $request_data = null)
	{
		...
		if ($this->contact->update($id, GestimagApiAccess::$user, 0, 'update') > 0) {
			return $this->get($id);
		} else {
	...
	{
		if (!GestimagApiAccess::$user->hasRight('societe', 'contact', 'supprimer')) {
		...
		return $this->contact->delete(GestimagApiAccess::$user);
	}
	...
	{
		//if (!GestimagApiAccess::$user->hasRight('user', 'user', 'creer')) {
		...
		if (!GestimagApi::_checkAccessToResource('contact', $contact->id, 'socpeople&societe')) {
			throw new RestException(403, 'Access not allowed for login '.GestimagApiAccess::$user->login);
		}
	...
	public function addCategory($id, $category_id)
	{
		...
		if (!GestimagApi::_checkAccessToResource('contact', $this->contact->id)) {
			throw new RestException(403, 'Access not allowed for login '.GestimagApiAccess::$user->login);
		}
