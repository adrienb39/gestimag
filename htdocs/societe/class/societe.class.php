 ...
 * Copyright (C) 2022		ButterflyOfFire         <butterflyoffire+gestimag@protonmail.com>
...
class Societe extends CommonObject
{
	...
	public function create(User $user, $notrigger = 0)
	{
		...
		// For automatic creation during create action (not used by Gestimag GUI, can be used by scripts)
