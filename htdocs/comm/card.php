...
if ($object->id > 0) {
	...
	*/
	...
	if (isModEnabled('member')) {
		...
		print '<tr><td class="titlefield">'.$langs->trans("LinkedToGestimagMember").'</td>';
		print '<td>';
		$adh = new Adherent($db);
	...
	$boxstat .= '<table summary="'.dol_escape_htmltag($langs->trans("GestimagStateBoard")).'" class="border boxtable boxtablenobottom boxtablenotop boxtablenomarginbottom centpercent">';
