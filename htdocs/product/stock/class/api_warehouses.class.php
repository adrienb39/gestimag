 ...
 */
class Warehouses extends GestimagApi
{
	/**
	...
	public function get($id)
	{
		...
		if (!GestimagApi::_checkAccessToResource('stock', $this->warehouse->id, 'entrepot')) {
	...
	public function post($request_data = null)
	{
		...
		if ($this->warehouse->create(GestimagApiAccess::$user) < 0) {
	...
	public function put($id, $request_data = null)
	{
		...
		if (!GestimagApi::_checkAccessToResource('stock', $this->warehouse->id)) {
			throw new RestException(403, 'Access not allowed for login '.GestimagApiAccess::$user->login);
		}
		...
		if ($this->warehouse->update($id, GestimagApiAccess::$user)) {
			return $this->get($id);
		} else {
	...
	public function delete($id)
	{
		...
		if (!$this->warehouse->delete(GestimagApiAccess::$user)) {
