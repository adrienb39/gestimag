...
class RecruitmentCandidature extends CommonObject
{
	...
	public $fields = array(
		...
		'fk_user' => array('type' => 'integer:User:user/class/user.class.php', 'label' => 'LinkedToGestimagUser', 'enabled' => 1, 'position' => 600, 'notnull' => 0, 'visible' => -1, 'csslist' => 'tdoverflowmax100'),
