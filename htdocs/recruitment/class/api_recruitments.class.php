 ...
 */
class Recruitments extends GestimagApi
{
	/**
	...
	{
		if (!GestimagApiAccess::$user->hasRight('recruitment', 'recruitmentjobposition', 'read')) {
		...
		if (!GestimagApi::_checkAccessToResource('recruitment', $this->jobposition->id, 'recruitment_recruitmentjobposition')) {
			throw new RestException(403, 'Access to instance id='.$this->jobposition->id.' of object not allowed for login '.GestimagApiAccess::$user->login);
		}
	...
	public function getCandidature($id)
	{
		...
		if (!GestimagApi::_checkAccessToResource('recruitment', $this->candidature->id, 'recruitment_recruitmentcandidature')) {
			throw new RestException(403, 'Access to instance id='.$this->candidature->id.' of object not allowed for login '.GestimagApiAccess::$user->login);
		}
	...
	{
		if (!GestimagApiAccess::$user->hasRight('recruitment', 'recruitmentjobposition', 'write')) {
			throw new RestException(403);
		}
		...
		if ($this->jobposition->create(GestimagApiAccess::$user)<0) {
	...
	*/
	public function postCandidature($request_data = null)
	{
		...
		if ($this->candidature->create(GestimagApiAccess::$user)<0) {
	...
	public function putJobPosition($id, $request_data = null)
	{
		...
		if ($this->jobposition->update(GestimagApiAccess::$user, false) > 0) {
	...
	public function putCandidature($id, $request_data = null)
	{
		...
		if ($this->candidature->update(GestimagApiAccess::$user, false) > 0) {
	...
	{
		if (!GestimagApiAccess::$user->hasRight('recruitment', 'recruitmentjobposition', 'delete')) {
			throw new RestException(403);
		}
		$result = $this->jobposition->fetch($id);
		if (!$result) {
		...
		if (!$this->jobposition->delete(GestimagApiAccess::$user)) {
	...
	public function deleteCandidature($id)
	{
		...
		if (!$this->candidature->delete(GestimagApiAccess::$user)) {
