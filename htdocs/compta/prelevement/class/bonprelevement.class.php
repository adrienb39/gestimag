...
class BonPrelevement extends CommonObject
{
	 ...
	 *		Note: Filter must be a Gestimag filter syntax string. Example: "(t.ref:like:'SO-%') or (t.date_creation:<:'20160101') or (t.status:!=:0) or (t.nature:is:NULL)"
	 ...
	 *
	 *	@param 	int		$banque				gestimag mysoc bank
	 *	@param	int		$agence				gestimag mysoc bank office (guichet)
		...
		if ($ok) {
			...
			if (!$error) {
				...
				if ($resql) {
					...
					// /home/ldestailleur/git/gestimag_15.0/documents/abc/
					// or
					// /home/ldestailleur/git/gestimag_15.0/documents/X/abc with X >= 2 with multicompany.
					if ($type != 'bank-transfer') {
