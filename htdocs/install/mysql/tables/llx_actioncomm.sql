...
-- This is also the table to track events on other Gestimag objects.
-- ========================================================================
...
(
  ...
  ref_ext			varchar(255),					-- reference into an external system (not used by gestimag). Example: An id coming from google calendar has length between 5 and 1024 chars. An event id must follow rule: chars used in base32hex encoding (i.e. lowercase letters a-v and digits 0-9, see section 3.1.2 in RFC2938)
