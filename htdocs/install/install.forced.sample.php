...
$force_install_message = 'Welcome to your Gestimag install';
...
$force_install_database = 'gestimag';
...
/** @var string $force_install_gestimaglogin		Gestimag super-administrator username */
$force_install_gestimaglogin = 'admin';
