...
/**
 *	\file       htdocs/debugbar/class/DataCollector/GestimagCollector.php
...
/**
 * GestimagCollector class
 */

class GestimagCollector extends DataCollector implements Renderable, AssetProvider
{
	/**
	...
	/**
	 *	Return gestimag info as an HTML string
	 *
	 * @return string      HTML string
	 */
	protected function getGestimagInfo()
	{
		global $conf, $langs;
		global $gestimag_main_prod, $gestimag_nocsrfcheck;
		...
		$info .= '$gestimag_main_prod = <strong>'.$gestimag_main_prod.'</strong><br>';
		$info .= '$gestimag_nocsrfcheck = <strong>'.$gestimag_nocsrfcheck.'</strong><br>';
	...
	{
		global $conf, $langs;
		global $gestimag_mailing_limit_sendbyweb, $gestimag_mailing_limit_sendbycli, $gestimag_mailing_limit_sendbyday;
		...
		$info .= 'gestimag_mailing_limit_sendbyweb = <strong>'.$gestimag_mailing_limit_sendbyweb.'</strong><br>';
		$info .= 'gestimag_mailing_limit_sendbycli = <strong>'.$gestimag_mailing_limit_sendbycli.'</strong><br>';
		$info .= 'gestimag_mailing_limit_sendbyday = <strong>'.$gestimag_mailing_limit_sendbyday.'</strong><br>';
