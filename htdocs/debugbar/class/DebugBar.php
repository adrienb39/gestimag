...
dol_include_once('/debugbar/class/DataCollector/GestimagCollector.php');
...
class GestimagDebugBar extends DebugBar
{
	...
	public function __construct()
	{
		...
		$this->addCollector(new GestimagCollector());
