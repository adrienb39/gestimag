 ...
 */
class MyModuleApi extends GestimagApi
{
	/**
	...
	{
		if (!GestimagApiAccess::$user->hasRight('mymodule', 'myobject', 'read')) {
			throw new RestException(403);
		}
		if (!GestimagApi::_checkAccessToResource('myobject', $id, 'mymodule_myobject')) {
			throw new RestException(403, 'Access to instance id='.$id.' of object not allowed for login '.GestimagApiAccess::$user->login);
		}
	...
	{
		if (!GestimagApiAccess::$user->hasRight('mymodule', 'myobject', 'write')) {
			throw new RestException(403);
		}
		...
		if ($this->myobject->create(GestimagApiAccess::$user)<0) {
	...
	public function put($id, $request_data = null)
	{
		...
		if (!GestimagApi::_checkAccessToResource('myobject', $id, 'mymodule_myobject')) {
			throw new RestException(403, 'Access to instance id='.$this->myobject->id.' of object not allowed for login '.GestimagApiAccess::$user->login);
		}
		...
		if ($this->myobject->update(GestimagApiAccess::$user, false) > 0) {
			return $this->get($id);
		} else {
	...
	{
		if (!GestimagApiAccess::$user->hasRight('mymodule', 'myobject', 'delete')) {
			throw new RestException(403);
		}
		if (!GestimagApi::_checkAccessToResource('myobject', $id, 'mymodule_myobject')) {
			throw new RestException(403, 'Access to instance id='.$this->myobject->id.' of object not allowed for login '.GestimagApiAccess::$user->login);
		...
		if ($this->myobject->delete(GestimagApiAccess::$user) == 0) {
			throw new RestException(409, 'Error when deleting MyObject : '.$this->myobject->error);
		} elseif ($this->myobject->delete(GestimagApiAccess::$user) < 0) {
