...
namespace Gestimag\test\functional;
...
class MyModuleFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	/**
	 * @var string Gestimag admin username
	 * @see authenticate()
	 */
	protected static $dol_admin_user = 'admin';
	/**
	 * @var string Gestimag admin password
	 * @see authenticate()
	 */
	protected static $dol_admin_pass = 'admin';
	/** @var int Gestimag module ID */
	...
	/**
	 * Handle Gestimag authentication
	 * @return void
	 */
	...
	public function testAboutPageRendersMarkdownReadme()
	{
		...
		return $this->assertEquals(
			'Gestimag Module Template (aka My Module)',
			$this->byTag('h1')->text(),
			"Readme title"
		);
	}
