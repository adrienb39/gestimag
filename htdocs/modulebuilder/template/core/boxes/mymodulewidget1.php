 ...
 *
 * Warning: for the box to be detected correctly by gestimag,
...
class mymodulewidget1 extends ModeleBoxes
{
	...
	/**
	 * Load data into info_box_contents array to show array later. Called by Gestimag before displaying the box.
	 *
	...
	/**
	 * Method to show box. Called by Gestimag eatch time it wants to display the box.
	 *
