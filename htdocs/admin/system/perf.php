...
print load_fiche_titre($langs->trans("PerfGestimag"), '', 'title_setup');

print '<span class="opacitymedium">'.$langs->trans("YouMayFindPerfAdviceHere", 'https://wiki.gestimag.org/index.php/FAQ_Increase_Performance').'</span>';
print ' &nbsp; &nbsp; ';
