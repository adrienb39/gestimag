...
/**
 *		\file 		htdocs/admin/tools/gestimag_export.php
 *		\ingroup	core
...
llxHeader('', '', $help_url, '', 0, 0, '', '', '', 'mod-admin page-tools_gestimag_export');
...
print $langs->trans("BackupDesc3", $gestimag_main_db_name).'<br>';
...
print '<span class="opacitymedium">'.$langs->trans("DatabaseName").' : </span><b>'.$gestimag_main_db_name.'</b><br><br>';
//print '</td>';
//print '</tr>';
...
if (!empty($_SESSION["commandbackuptorun"])) {
	print '<br><span class="warning">'.$langs->trans("YouMustRunCommandFromCommandLineAfterLoginToUser", $gestimag_main_db_user, $gestimag_main_db_user).':</span><br>'."\n";
...
$prefix = 'documents';
$ext = 'zip';
$file = $prefix.'_'.$gestimag_main_db_name.'_'.dol_sanitizeFileName(DOL_VERSION).'_'.dol_print_date(dol_now('gmt'), "dayhourlogsmall", 'tzuser');
