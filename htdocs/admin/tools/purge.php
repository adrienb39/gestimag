...
print '<span class="opacitymedium">'.$langs->trans("PurgeAreaDesc", $gestimag_main_data_root).'</span><br>';
print '<br>';
...
if (isModEnabled('syslog')) {
	...
	if ($user->admin && preg_match('/^gestimag.*\.log$/', basename($filelog))) {
...
print '> <label for="choiceallfiles">'.$langs->trans("PurgeDeleteAllFilesInDocumentsDir", $gestimag_main_data_root).'</label>';
print '<br>';
