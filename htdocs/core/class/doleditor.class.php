...
class DolEditor
{
	 ...
	 *  @param 	string				$toolbarname	       		 	Name of bar set to use ('Full', 'gestimag_notes[_encoded]', 'gestimag_details[_encoded]'=the less featured, 'gestimag_mailings[_encoded]', 'gestimag_readonly').
