...
class vCard
{
	...
	public function buildVCardString($object, $company, $langs, $urlphoto = '', $outdir = '')
	{
		...
		$this->setProdId('Gestimag '.DOL_VERSION);

		$this->setUID('DOLIBARR-USERID-'.dol_trunc(md5('vcard'.$gestimag_main_instance_unique_id), 8, 'right', 'UTF-8', 1).'-'.$object->id);
