...
class Canvas
{
	...
	public function getCanvas($module, $card, $canvas)
	{
		...
		// Set properties with value specific to gestimag core: this->targetmodule, this->card, this->canvas
		...
		//echo 'dimodule='.$dirmodule.' canvas='.$this->canvas.'<br>';
		//echo ' => template_dir='.$this->template_dir.'<br>';
	}
	...
	// https://wiki.gestimag.org/index.php/Canvas_development
	 ...
	 * 	@see		https://wiki.gestimag.org/index.php/Canvas_development
	 */
