 ...
 */
abstract class GestimagTriggers
{
	/**
	 * Database handler
	 * @var DoliDB
	...
	/**
	 * @var string module is gestimag ready
	 * @deprecated Use self::VERSIONS
	 * @see self::VERSIONS
	 */
	const VERSION_DOLIBARR = 'gestimag';
	...
	public function getVersion()
	{
		global $langs;
		$langs->load("admin");
		switch ($this->version) { // TODO use a match expression @ Gestimag minimum PHP v8.0
