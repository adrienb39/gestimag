 ...
 */
class InterfaceLogevents extends GestimagTriggers
{
	...
	public function __construct(DoliDB $db)
	{
		...
		$this->family 		= "core";
		$this->description  = "Triggers of this module allows to add security event records inside Gestimag.";
	...
	/**
	 * Function called when a Gestimag security audit event is done.
