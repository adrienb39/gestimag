...
if (!$error && ($massaction == 'delete' || ($action == 'delete' && $confirm == 'yes')) && $permissiontodelete) {
	...
	//$toselect could contain duplicate entries, cf https://github.com/Gestimag/gestimag/issues/26244
			...
			if ($user->id == $objecttmp->fk_validator) {
				...
				if (!$error) {
					...
					if (!$emailTo) {
						...
						$message .= "- ".$langs->transnoentitiesnoconv("Link")." : ".$gestimag_main_url_root."/holiday/card.php?id=".$objecttmp->id."\n\n";
						$message .= "\n";
