...
/**
 *    Class to manage Gestimag database access for an SQL database
 */
interface Database
{
	/**
	 ...
	 *
	 * @param    string $gestimag_main_db_host 	Server IP
	 * @param    string $gestimag_main_db_user 	Username to create
	 * @param    string $gestimag_main_db_pass 	User password to create
