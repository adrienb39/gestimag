...
/**
 *	Class to drive a PostgreSQL database for Gestimag
 */
class DoliDBPgsql extends DoliDB
{
	...
	public function convertSQLFromMysql($line, $type = 'auto', $unescapeslashquot = false)
	{
		...
		if ($line != "") {
			...
			if ($type == 'dml') {
				...
				// ALTER TABLE llx_gestimag_modules DROP PRIMARY KEY pk_xxx
	...
	public function DDLCreateDb($database, $charset = '', $collation = '', $owner = '')
	{
		...
		//echo$charset.' '.setlocale(LC_CTYPE,'0'); exit;
	 ...
	 *
	 *	@param	string	$gestimag_main_db_host 		Ip server
	 *	@param	string	$gestimag_main_db_user 		Name of user to create
	 *	@param	string	$gestimag_main_db_pass 		Password of user to create
	...
	public function DDLCreateUser($gestimag_main_db_host, $gestimag_main_db_user, $gestimag_main_db_pass, $gestimag_main_db_name)
	{
		...
		$sql = "CREATE USER ".$this->sanitize($gestimag_main_db_user)." with password '".$this->escape($gestimag_main_db_pass)."'";
