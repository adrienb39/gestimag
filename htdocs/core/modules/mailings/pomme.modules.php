...
{
	public $name = 'GestimagUsers'; // Identifiant du module mailing
	// This label is used if no translation is found for key XXX neither MailingModuleDescXXX where XXX=name is found
	public $desc = 'Gestimag users with emails'; // Libelle utilise si aucune traduction pour MailingModuleDescXXX ou XXX=name trouv�e
	...
	public function getSqlArrayForStats()
	{
		...
		$statssql = array();
		$sql = "SELECT '".$this->db->escape($langs->trans("GestimagUsers"))."' as label,";
