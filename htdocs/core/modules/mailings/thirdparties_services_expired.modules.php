...
{
	public $name = 'GestimagContractsLinesExpired';
	...
	public function __construct($db)
	{
		...
		if ($result) {
			...
			dol_syslog("gestimag_services_expired.modules.php:mailing_gestimag_services_expired ".$num." services found");
	...
	public function getNbOfRecipients($sql = '')
	{
		...
		// Example: return parent::getNbOfRecipients("SELECT count(*) as nb from gestimag_table");
		// Example: return 500;
