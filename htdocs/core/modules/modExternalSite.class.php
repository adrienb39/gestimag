 ...
 * \brief      Module to include an external web site/tools into Gestimag menu and into a frame page.
 ...
 */
class modExternalSite extends GestimagModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->description = "This module include an external web site or page into Gestimag menus and view it into a Gestimag frame.";
