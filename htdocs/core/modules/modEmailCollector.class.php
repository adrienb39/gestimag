 ...
 */
class modEmailCollector extends GestimagModules
{
	/**
	...
	public function init($options = '')
	{
		...
		if ($tmpresql) {
			if ($this->db->num_rows($tmpresql) == 0) {
				$descriptionB1 = $langs->trans('EmailCollectorExampleToCollectGestimagAnswersDesc');
				$label = $langs->trans('EmailCollectorExampleToCollectGestimagAnswers');
