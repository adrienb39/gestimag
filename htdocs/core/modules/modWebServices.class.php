 ...
 *      \brief      Module to enable the Gestimag server of web services
 ...
 */
class modWebServices extends GestimagModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->description = "Enable the Gestimag web services server";
		...
		$this->version = 'gestimag_deprecated';
