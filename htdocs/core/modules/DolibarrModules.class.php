...
/**
 * \file           htdocs/core/modules/GestimagModules.class.php
 * \brief          File of parent class of module descriptor class files
 */


/**
 * Class GestimagModules
 *
 * Parent class for module descriptor class files
 */
class GestimagModules // Can not be abstract, because we need to instantiate it into unActivateModule to be able to disable a module whose files were removed.
{
	/**
	 ...
	 * @see https://wiki.gestimag.org/index.php/List_of_modules_id
	 */
	public $numero;
	 ...
	 * 'development'
	 * 'experimental'
	 * 'gestimag': only for core modules that share its version
	 * 'gestimag_deprecated': only for deprecated core modules
	 */
	public $version;
	...
	/**
	 * @var array Minimum version of Gestimag required by module.
	 * e.g.: Gestimag ≥ 3.6 = array(3, 6)
	 */
	public $need_gestimag_version;
	...
	// We should but can't set this as abstract because this will make gestimag hang
	 ...
	 * For 'gestimag' modules, gives Gestimag version
	 *
	...
	{
		if (in_array($this->version, array('gestimag', 'experimental', 'development'))) {	// core module
	 ...
	 * 'gestimag' and 'gestimag_deprecated' is core
	...
	{
		if ($this->version == 'gestimag' || $this->version == 'gestimag_deprecated') {
			return 'core';
		}
	 ...
	 * The init function adds tabs, constants, boxes, permissions and menus (defined in constructor) into Gestimag database.
	 ...
	 * The remove function removes tabs, constants, boxes, permissions and menus from Gestimag database.
