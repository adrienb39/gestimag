 ...
 *  \brief      Module to make generic import of data into gestimag database
 ...
 */
class modImport extends GestimagModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->description = "Outils d'imports de donnees Gestimag (via un assistant)";
		...
		$this->phpmax = array();
		$this->need_gestimag_version = array(2, 7, -1); // Minimum version of Gestimag required by module
