 ...
 */
class modWebPortal extends GestimagModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 11000; // TODO Go on page https://wiki.gestimag.org/index.php/List_of_modules_id to reserve an id number for your module
		...
		// Author
		//$this->editor_name = 'Gestimag';
		//$this->editor_url = 'gestimag.org';

		// Possible values for version are: 'development', 'experimental', 'gestimag', 'gestimag_deprecated', 'experimental_deprecated' or a version string like 'x.y.z'
