 ...
 */
require_once DOL_DOCUMENT_ROOT."/core/modules/GestimagModules.class.php";


/**
 * Description and activation class for module Ticket
 */
class modTicket extends GestimagModules
{
	/**
	...
	public function __construct($db)
	{
		...
		// Use a free id here
		// (See in Home -> System information -> Gestimag for list of used modules id).
		$this->numero = 56000;
		...
		$this->const = array(
			...
			9 => array('TICKET_NOTIFICATION_EMAIL_FROM', 'chaine', getDolGlobalString('MAIN_MAIL_EMAIL_FROM'), 'Email to use by default as sender for messages sent from Gestimag', 0),
			10 => array('TICKET_MESSAGE_MAIL_INTRO', 'chaine', $langs->trans('TicketMessageMailIntroText'), 'Introduction text of ticket replies sent from Gestimag', 0),
			11 => array('TICKET_MESSAGE_MAIL_SIGNATURE', 'chaine', $default_footer, 'Signature to use by default for messages sent from Gestimag', 0),
