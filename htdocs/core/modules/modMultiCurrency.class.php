 ...
 */
class modMultiCurrency extends GestimagModules
{
	/**
	...
	public function __construct($db)
	{
		...
		// Possible values for version are: 'development', 'experimental', 'gestimag' or 'gestimag_deprecated' or version
		...
		$this->need_gestimag_version = array(3, 0); // Minimum version of Gestimag required by module
