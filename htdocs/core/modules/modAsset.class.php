 ...
 */
class modAsset extends GestimagModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 51000; // TODO Go on page https://wiki.gestimag.org/index.php/List_of_modules_id to reserve id number for your module
		...
		$this->descriptionlong = "Asset module to manage assets module and depreciation charge on Gestimag";
		...
		$this->need_gestimag_version = array(7, 0); // Minimum version of Gestimag required by module
