 ...
 *  \brief      Module to manage data exports from Gestimag database
 *
 ...
 */
class modExport extends GestimagModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->description = "Outils d'exports de donnees Gestimag (via un assistant)";
