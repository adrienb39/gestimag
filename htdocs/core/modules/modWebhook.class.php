 ...
 */
class modWebhook extends GestimagModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 68305; // TODO Go on page https://wiki.gestimag.org/index.php/List_of_modules_id to reserve an id number for your module
		...
		$this->descriptionlong = "Interface to catch gestimag triggers and send data of the event to an external URL";
		...
		$this->need_gestimag_version = array(11, -3); // Minimum version of Gestimag required by module
