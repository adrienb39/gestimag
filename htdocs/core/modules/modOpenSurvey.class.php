 ...
 */
class modOpenSurvey extends GestimagModules
{
	/**
	...
	public function __construct($db)
	{
		...
		// Use here a free id (See in Home -> System information -> Gestimag for list of used module id).
		$this->numero = 55000;
		...
		// Possible values for version are: 'development', 'experimental', 'gestimag' or version
		...
		$this->need_gestimag_version = array(3, 4, 0); // Minimum version of Gestimag required by module
