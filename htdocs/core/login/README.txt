...
Once this is done, when you log in to Gestimag, the function 
check_user_mypasschecker in this file is called.
If the function return true and login exists, login is accepted.



See page https://wiki.gestimag.org/index.php?title=Authentication,_SSO_and_SSL for more information.
