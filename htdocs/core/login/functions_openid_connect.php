 ...
 *
 *      See https://github.com/Gestimag/gestimag/issues/22740 for more information about setup openid_connect
 */
	...
	if (GETPOSTISSET('username')) {
		...
		if ($state === hash('sha256', session_id())) {
			...
			if (property_exists($token_content, 'access_token')) {
				...
				// Get the user attribute (claim) matching the Gestimag login
				...
				if (property_exists($userinfo_content, $login_claim)) {
					// Success: retrieve claim to return to Gestimag as login
