...
{
	// Fixed by Matelli (see http://matelli.fr/showcases/patch%73-gestimag/fix-cleaning-url.html)
 ...
 *
 *	@see		gestimag_get_const(), gestimag_set_const(), gestimag_del_const()
 */
...
/**
 * 	Return Gestimag version
 *
 * 	@return		string			Gestimag version
 *  @see		versiongestimagarray(), versioncompare()
 */
function version_gestimag()
{
	return DOL_VERSION;
}
