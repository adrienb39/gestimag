...
function dolSessionOpen($save_path, $session_name)
{
	...
	global $gestimag_main_db_type, $gestimag_main_db_host;
	global $gestimag_main_db_user, $gestimag_main_db_pass, $gestimag_main_db_name, $gestimag_main_db_port;

	global $gestimag_session_db_type, $gestimag_session_db_host;
	global $gestimag_session_db_user, $gestimag_session_db_pass, $gestimag_session_db_name, $gestimag_session_db_port;

	if (empty($gestimag_session_db_type)) {
		$gestimag_session_db_type = $gestimag_main_db_type;
	}
	if (empty($gestimag_session_db_host)) {
		$gestimag_session_db_host = $gestimag_main_db_host;
	}
	if (empty($gestimag_session_db_user)) {
		$gestimag_session_db_user = $gestimag_main_db_user;
	}
	if (empty($gestimag_session_db_pass)) {
		$gestimag_session_db_pass = $gestimag_main_db_pass;
	}
	if (empty($gestimag_session_db_name)) {
		$gestimag_session_db_name = $gestimag_main_db_name;
	}
	if (empty($gestimag_session_db_port)) {
		$gestimag_session_db_port = $gestimag_main_db_port;
	}
	//var_dump('open '.$database_name.' '.$table_name);

	$dbsession = getDoliDBInstance($gestimag_session_db_type, $gestimag_session_db_host, $gestimag_session_db_user, $gestimag_session_db_pass, $gestimag_session_db_name, (int) $gestimag_session_db_port);
