 ...
 *
 * for creating a new dictionary table in Gestimag. It generates the necessary SQL code to define the table structure,
 ...
 * @param 	string 		$file 			The file path to the Gestimag module builder file where the dictionaries are defined.
