...
/**
 *	\file       htdocs/core/boxes/box_gestimag_state_board.php
 *	\ingroup	core
 *	\brief      Module Gestimag state base
 */
 ...
 */
class box_gestimag_state_board extends ModeleBoxes
{
	public $boxcode = "gestimagstatebox";
	public $boximg = "generic";
	public $boxlabel = "BoxGestimagStateBoard";
	...
	public function loadBox($max = 5)
	{
		...
		$this->max = $max;
		$this->info_box_head = array('text' => $langs->trans("GestimagStateBoard"));
