...
// Title
$title = $langs->trans("HomeArea").' - Gestimag '.DOL_VERSION;
...
// Gestimag Working Board with weather
if (!getDolGlobalString('MAIN_DISABLE_GLOBAL_WORKBOARD') && getDolGlobalInt('MAIN_OPTIMIZEFORTEXTBROWSER') < 2) {
	...
	$boxwork .= '<th class="liste_titre"><div class="inline-block valignmiddle">'.$langs->trans("GestimagWorkBoard").'</div>';
	if ($showweather) {
		if ($totallate > 0) {
