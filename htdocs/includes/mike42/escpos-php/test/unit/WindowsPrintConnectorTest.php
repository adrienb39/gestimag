...
class WindowsPrintConnectorTest extends PHPUnit\Framework\TestCase
{
    ...
    {
        // Cannot echo to local printer on Mac with this connector
    ...
    {
        // Cannot echo to local printer on Linux with this connector
        $this -> expectException(BadMethodCallException::class);
    ...
    public function testSharedPrinterLinux()
    {
        ...
        $connector -> expects($this -> once())
                -> method('runCommand')
                -> with($this -> equalTo('smbclient \'//example-pc/Printer\' -c \'echo -\' -N -m SMB2'));
        $connector -> expects($this -> exactly(0))
                -> method('runCopy');
        $connector -> expects($this -> exactly(0))
                -> method('runWrite');
    ...
    public function testSharedPrinterLinuxUsername()
    {
        ...
        $connector -> expects($this -> once())
                -> method('runCommand')
                -> with($this -> equalTo('smbclient \'//example-pc/Printer\' -U \'bob\' -c \'echo -\' -N -m SMB2'));
        $connector -> expects($this -> exactly(0))
                -> method('runCopy');
        $connector -> expects($this -> exactly(0))
                -> method('runWrite');
    ...
    public function testSharedPrinterLinuxUsernameDomain()
    {
        ...
        $connector -> expects($this -> once())
                -> method('runCommand')
                -> with($this -> equalTo('smbclient \'//example-pc/Printer\' -U \'home\\bob\' -c \'echo -\' -N -m SMB2'));
        $connector -> expects($this -> exactly(0))
                -> method('runCopy');
        $connector -> expects($this -> exactly(0))
                -> method('runWrite');
    ...
    public function testSharedPrinterLinuxUsernamePassword()
    {
        ...
        $connector -> expects($this -> once())
                -> method('runCommand')
                -> with($this -> equalTo('smbclient \'//example-pc/Printer\' \'secret\' -U \'bob\' -c \'echo -\' -m SMB2'));
        $connector -> expects($this -> exactly(0))
                -> method('runCopy');
        $connector -> expects($this -> exactly(0))
                -> method('runWrite');
