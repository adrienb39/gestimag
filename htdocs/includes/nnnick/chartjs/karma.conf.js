...
module.exports = function(karma) {
  ...
  karma.set({
    ...
    specReporter: {
      ...
      suppressErrorSummary: true, // do not echo error summary
      suppressFailed: false,      // do not echo information about failed tests
      suppressPassed: true,      // do not echo information about passed tests
      suppressSkipped: false,      // do not echo information about skipped tests
      showSpecTiming: false,      // echo the time elapsed for each spec
