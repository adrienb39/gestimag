...
:root {
	...
	--colortexttitle: rgba(<?php echo $colortexttitle; ?>, 0.9);
...
{
	div.refidno {
		font-size: <?php echo is_numeric($fontsize) ? ((int) $fontsize + 3).'px' : $fontsize; ?> !important;
	}
	.divadvancedsearchfield {
		padding-left: 5px;
		padding-right: 5px;
...
@media only screen and (max-width: <?php echo  getDolGlobalString('THEME_ELDY_WITDHOFFSET_FOR_REDUC3', round($nbtopmenuentries * 47, 0) + 130); ?>px)	/* reduction 3 */
{
	...
	div.fiche {
		margin-<?php echo $left; ?>: 9px !important;
		margin-<?php echo $right; ?>: 10px !important;
	}
...
{
	div.fiche {
		margin-<?php echo $left; ?>: 13px !important;
		margin-<?php echo $right; ?>: 14px !important;
	}
}
<?php } ?>
...
div.fiche {
	margin-<?php echo $left; ?>: <?php print(GETPOST('optioncss', 'aZ09') == 'print' ? 6 : (empty($conf->dol_optimize_smallscreen) ? '42' : '6')); ?>px;
	margin-<?php echo $right; ?>: <?php print(GETPOST('optioncss', 'aZ09') == 'print' ? 6 : (empty($conf->dol_optimize_smallscreen) ? '38' : '6')); ?>px;
...
{
	div.fiche {
		margin-<?php echo $left; ?>: <?php print(GETPOST('optioncss', 'aZ09') == 'print' ? 6 : ($dol_hide_leftmenu ? '6' : '20')); ?>px;
		margin-<?php echo $right; ?>: <?php print(GETPOST('optioncss', 'aZ09') == 'print' ? 8 : 6); ?>px;
	}
	div.fichecenter {
		width: 100%;
		clear: both;	/* This is to have div fichecenter that are true rectangles */
...
div.mainmenu.menu {
	<?php echo $disableimages ? '' : 'top: 10px'; ?>
}
...
div.login_block {
	...
	text-align: <?php echo $right; ?>;
	<?php echo $right; ?>: 0;
	top: <?php echo $disableimages ? '4px' : '0'; ?>;
	line-height: 10px;
...
a.vmenu:link, a.vmenu:visited, a.vmenu:hover, a.vmenu:active, span.vmenu, span.vsmenu {
	white-space: nowrap; font-family: <?php echo $fontlist ?>; text-align: <?php echo $left; ?>;
}
...
span.vmenudisabled {
	...
	font-family: <?php echo $fontlist ?>; text-align: <?php echo $left; ?>; font-weight: bold; color: #aaa; margin-left: 4px; white-space: nowrap;
}
...
a.help:link, a.help:visited, a.help:hover, a.help:active, span.help {
	text-align: <?php echo $left; ?>; color: #aaa; text-decoration: none;
}
...
table.dp {
	...
	border-<?php echo $left; ?>: solid 2px #DDDDDD;
...
.cal_current_month { background: #FFFFFF; border-left: solid 1px #E0E0E0; padding-<?php echo $left; ?>: 2px; padding-<?php echo $right; ?>: 1px; padding-top: 0px; padding-bottom: 0px !important; }
...
.cal_past          { }
.cal_peruser       { padding-top: 0 !important; padding-bottom: 0 !important; padding-<?php echo $left; ?>: 1px !important; padding-<?php echo $right; ?>: 1px !important; }
.cal_impair        {
...
echo getDolGlobalString('THEME_CUSTOM_CSS');
