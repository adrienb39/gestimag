 ...
 */
class Interventions extends GestimagApi
{
	/**
	...
	{
		if (!GestimagApiAccess::$user->hasRight('ficheinter', 'lire')) {
		...
		if (!GestimagApi::_checkAccessToResource('fichinter', $this->fichinter->id)) {
	...
	{
		if (!GestimagApiAccess::$user->hasRight('ficheinter', 'creer')) {
		...
		if ($this->fichinter->create(GestimagApiAccess::$user) < 0) {
	...
	*/
	...
	{
		if (!GestimagApiAccess::$user->hasRight('ficheinter', 'supprimer')) {
			throw new RestException(403);
		}
		$result = $this->fichinter->fetch($id);
		if (!$result) {
		...
		if (!$this->fichinter->delete(GestimagApiAccess::$user)) {
	...
	public function validate($id, $notrigger = 0)
	{
		...
		$result = $this->fichinter->setValid(GestimagApiAccess::$user, $notrigger);
		if ($result == 0) {
