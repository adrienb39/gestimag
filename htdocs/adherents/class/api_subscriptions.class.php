 ...
 */
class Subscriptions extends GestimagApi
{
	/**
	...
	public function post($request_data = null)
	{
		...
		if ($subscription->create(GestimagApiAccess::$user) < 0) {
	...
	public function put($id, $request_data = null)
	{
		...
		if ($subscription->update(GestimagApiAccess::$user) > 0) {
			return $this->get($id);
		} else {
	...
	public function delete($id)
	{
		...
		$res = $subscription->delete(GestimagApiAccess::$user);
		if ($res < 0) {
