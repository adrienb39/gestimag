...
## Integrate your ERP with any other applications using Gestimag APIs
 
This module provides the service to make Gestimag a server of REST Web Services. It depends on external library Restler.
...
<div align="center">
  <img class="imgdoc" src="https://www.gestimag.org//images/doc_apirest.png" alt="Gestimag API explorer"/>
</div>
...
You can explore all available APIs by using the API explorer : [**yourgestimag.tld**/api/index.php/explorer](../api/index.php/explorer) (replace **yourgestimag.tld** by real hostname of your Gestimag installation)
...
https://**yourgestimag.tld**/mygestimag/api/index.php/otherservice?DOLAPIKEY=**api_key**
...
To implement it into Gestimag, you need to create a specific class for object we want to use. A skeleton file is available into /modulebuilder/class directory : *api_mymodule_class.class.php* 
