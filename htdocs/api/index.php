...
/**
 * 	\defgroup   api     Module GestimagApi
 *  \brief      API loader
...
$api = new GestimagApi($db, '', $refreshcache);
//var_dump($api->r->apiVersionMap);

// If MAIN_API_DEBUG is set to 1, we save logs into file "gestimag_api.log"
...
$api->r->addAuthenticationClass('GestimagApiAccess', '');
...
if (getDolGlobalInt("API_ENABLE_COUNT_CALLS") && $api->r->responseCode == 200) {
	$error = 0;
	$db->begin();
	$userid = GestimagApiAccess::$user->id;
