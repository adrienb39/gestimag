...
if ($user->hasRight('categorie', 'creer')) {
	...
	if ($action == 'create' || $action == 'add') {
		...
		$doleditor = new DolEditor('description', $description, '', 160, 'gestimag_notes', '', false, true, isModEnabled('fckeditor') && getDolGlobalInt('FCKEDITOR_ENABLE_SOCIETE'), ROWS_5, '90%');
		$doleditor->Create();
		print '</td></tr>';
