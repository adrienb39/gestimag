...
if ($action == 'setPARTNERSHIP_ENABLE_PUBLIC') {
	if (GETPOST('value')) {
		gestimag_set_const($db, 'PARTNERSHIP_ENABLE_PUBLIC', 1, 'chaine', 0, '', $conf->entity);
	} else {
		gestimag_set_const($db, 'PARTNERSHIP_ENABLE_PUBLIC', 0, 'chaine', 0, '', $conf->entity);
	}
}
...
if ($action == 'update') {
	...
	$res = gestimag_set_const($db, "PARTNERSHIP_ENABLE_PUBLIC", $public, 'chaine', 0, '', $conf->entity);
