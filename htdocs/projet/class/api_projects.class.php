 ...
 */
class Projects extends GestimagApi
{
	/**
	...
	public function post($request_data = null)
	{
		...
		if ($this->project->create(GestimagApiAccess::$user) < 0) {
	...
	*/
	...
	public function put($id, $request_data = null)
	{
		...
		if ($this->project->update(GestimagApiAccess::$user) >= 0) {
			return $this->get($id);
		} else {
	...
	public function delete($id)
	{
		...
		if (!$this->project->delete(GestimagApiAccess::$user)) {
	...
	public function validate($id, $notrigger = 0)
	{
		...
		$result = $this->project->setValid(GestimagApiAccess::$user, $notrigger);
		if ($result == 0) {
