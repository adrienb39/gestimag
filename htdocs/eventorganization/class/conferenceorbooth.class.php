...
class ConferenceOrBooth extends ActionComm
{
	 ...
	 *		Note: Filter must be a Gestimag Universal Filter syntax string. Example: "(t.ref:like:'SO-%') or (t.date_creation:<:'20160101') or (t.status:!=:0) or (t.nature:is:NULL)"
	...
	{
		global $gestimag_main_url_root, $conf, $langs;

		$result = parent::fetch($id, $ref, $ref_ext, $email_msgid);

		$link_subscription = $gestimag_main_url_root.'/public/eventorganization/attendee_new.php?id='.urlencode((string) ($id)).'&type=conf';
