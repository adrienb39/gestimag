...
class WorkstationUserGroup extends CommonObject
{
	...
	/** @var string $element Name of the element (tip for better integration in Gestimag: this value should be the reflection of the class name with ucfirst() function) */
