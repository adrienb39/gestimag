 ...
 */
class MultiCurrencies extends GestimagApi
{
	/**
	 * Constructor
	 */
	...
	public function index($sortfield = "t.rowid", $sortorder = 'ASC', $limit = 100, $page = 0, $sqlfilters = '', $properties = '')
	{
		...
		if (!GestimagApiAccess::$user->hasRight('multicurrency', 'currency', 'read')) {
	...
	public function post($request_data = null)
	{
		...
		if (!GestimagApiAccess::$user->hasRight('multicurrency', 'currency', 'write')) {
		...
		// Create Currency
		if ($multicurrency->create(GestimagApiAccess::$user) < 0) {
	...
	public function put($id, $request_data = null)
	{
		...
		if ($multicurrency->update(GestimagApiAccess::$user) < 0) {
	...
	{
		if (!GestimagApiAccess::$user->hasRight('multicurrency', 'currency', 'delete')) {
		...
		if (!$multicurrency->delete(GestimagApiAccess::$user)) {
