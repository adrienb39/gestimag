...
$server->configureWSDL('WebServicesGestimagInvoice', $ns);
 ...
 *
 * @param	array{login:string,password:string,entity:?int,gestimagkey:string}	$authentication		Array of authentication information
