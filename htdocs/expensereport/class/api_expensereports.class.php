 ...
 */
class ExpenseReports extends GestimagApi
{
	/**
	...
	{
		if (!GestimagApiAccess::$user->hasRight('expensereport', 'lire')) {
		...
		if (!GestimagApi::_checkAccessToResource('expensereport', $this->expensereport->id)) {
	...
	{
		if (!GestimagApiAccess::$user->hasRight('expensereport', 'creer')) {
		...
		if ($this->expensereport->create(GestimagApiAccess::$user) < 0) {
	...
	*/
	...
	public function put($id, $request_data = null)
	{
		...
		if ($this->expensereport->update(GestimagApiAccess::$user) > 0) {
			return $this->get($id);
		} else {
	...
	{
		if (!GestimagApiAccess::$user->hasRight('expensereport', 'supprimer')) {
			throw new RestException(403);
		}
		...
		if (!$this->expensereport->delete(GestimagApiAccess::$user)) {
	...
	public function validate($id, $idwarehouse=0)
	{
		...
		if( ! $this->expensereport->valid(GestimagApiAccess::$user, $idwarehouse)) {
	...
	public function addPayment($id, $request_data = null)
	{
		...
		if ($paymentExpenseReport->create(GestimagApiAccess::$user) < 0) {
	...
	public function updatePayment($id, $request_data = null)
	{
		...
		if ($paymentExpenseReport->update(GestimagApiAccess::$user) > 0) {
			return $this->get($id);
		} else {
	...
	/*public function delete($id)
	 ...
	 if ($paymentExpenseReport->delete(GestimagApiAccess::$user) < 0) {
