 ...
 * \ingroup facture
 * \brief Script to send a mail to gestimag users linked to companies with unpaid invoices
 */
...
if ($resql) {
	...
	if ($num) {
		...
		print "No unpaid invoices (for companies linked to a particular commercial gestimag user) found\n";
	}
