...
/**
 * \file scripts/user/sync_users_ldap2gestimag.php
 * \ingroup ldap member
 * \brief Script to update users into Gestimag from LDAP
 */
...
if (!getDolGlobalString('LDAP_USER_DN')) {
	print $langs->trans("Error").': '.$langs->trans("LDAP setup for users not defined inside Gestimag");
	exit(1);
}
