...
/**
 * \file scripts/members/sync_members_gestimag2ldap.php
 * \ingroup ldap member
 * \brief Script de mise a jour des adherents dans LDAP depuis base Gestimag
 */
...
print "\n";
print "----- Synchronize all records from Gestimag database:\n";
 ...
 * print $langs->trans("LDAPSynchronizationNotSetupInGestimag");
 * exit(1);
 * }
 */
