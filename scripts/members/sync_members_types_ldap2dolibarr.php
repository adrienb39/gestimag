...
/**
 * \file 	scripts/members/sync_members_types_ldap2gestimag.php
 * \ingroup ldap member
 * \brief 	Script to update members types into Gestimag from LDAP
 */
...
if (!getDolGlobalString('LDAP_MEMBER_TYPE_DN')) {
	print $langs->trans("Error").': '.$langs->trans("LDAP setup for members types not defined inside Gestimag");
	exit(1);
}
