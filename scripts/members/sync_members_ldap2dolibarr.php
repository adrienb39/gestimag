...
/**
 * \file scripts/members/sync_members_ldap2gestimag.php
 * \ingroup ldap member
 * \brief Script de mise a jour des adherents dans Gestimag depuis LDAP
 */
...
if (!getDolGlobalString('LDAP_MEMBER_DN')) {
	print $langs->trans("Error").': '.$langs->trans("LDAP setup for members not defined inside Gestimag")."\n";
	exit(1);
}
if ($typeid <= 0) {
