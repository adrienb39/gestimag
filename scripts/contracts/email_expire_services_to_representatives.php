 ...
 * \ingroup contracts
 * \brief Script to send a mail to gestimag users linked to companies with services to expire
 */
...
if ($resql) {
	...
	if ($num) {
		...
		print "No services to expire (for companies linked to a particular commercial gestimag user) found\n";
	}
