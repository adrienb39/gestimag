...
# Gestimag variable MAIN_ODT_AS_PDF must be defined ...
...
# Gestimag variable MAIN_DOL_SCRIPTS_ROOT must be defined to path of script directories (otherwise gestimag will try to guess).
#
